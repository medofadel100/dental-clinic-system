            ...
            >
              ...
              <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                ...
                >
                  ...
                  <select
                    name="salary_system"
                    defaultValue={member.salary_system || "Fixed"}
                    style={{
                      padding: "0.5rem",
                      borderRadius: "var(--radius-md)",
                ...
                >
                  ...
                  <input
                    type="number"
                    name="salary_value"
                    defaultValue={member.salary_value || 0}
                    required
                    step="0.01"
                    style={{
                      padding: "0.5rem",
                ...
                >
                  ...
                  <input
                    ...
                    defaultValue={member.percentage_value || 0}
                    required
                    step="0.01"
                    style={{
                      padding: "0.5rem",
              ...
              >
                ...
                >
                  ...
                  <input
                    type="number"
                    name="bonus_amount"
                    defaultValue={member.bonus_amount || 0}
                    required
                    step="0.01"
                    style={{
                      padding: "0.5rem",
                ...
                >
                  ...
                  <input
                    ...
                    defaultValue={member.deduction_amount || 0}
                    required
                    step="0.01"
                    style={{
                      padding: "0.5rem",
