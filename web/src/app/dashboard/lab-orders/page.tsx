          ...
          {orders?.length === 0 ? (
            ...
            >
              ...
              <p style={{ color: "var(--text-secondary)" }}>
                لا توجد طلبات معمل مسجلة حتى الآن.
              </p>
            </div>
          ) : (
            orders?.map((order) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <span>
                      <strong>المعمل:</strong> {order.lab_name}
                    </span>
                    <span>
                      <strong>المريض:</strong>{" "}
                      {(order.patients as any)?.full_name || "غير محدد"}
                    </span>
                    <span>
                      <strong>الطبيب:</strong>{" "}
                      {(order.profiles as any)?.full_name || "غير محدد"}
                    </span>
                  </div>
                  ...
                  >
                    <span>
                      ...
                      {new Date(order.sent_date).toLocaleDateString("ar-EG")}
                    </span>
          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="مثال: طربوش زركون للسن 36"
                required
                style={{
                  padding: "0.75rem",
                  borderRadius: "4px",
