    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
      <div>
        ...
        <p style={{ color: "var(--text-secondary)" }}>
          اربط رقم الواتساب الخاص بالعيادة لتفعيل الرد الآلي وتذكير المواعيد للمرضى.
        </p>
      </div>
      ...
      <div style={{
        ...
        {status === 'loading' ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
            ...
            <h2 style={{ color: "var(--success)", fontSize: "1.5rem" }}>تم الربط بنجاح!</h2>
            <p style={{ color: "var(--text-secondary)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <p style={{ color: "var(--text-secondary)" }}>
              افتح الواتساب من موبايل العيادة ➔ الأجهزة المرتبطة ➔ ربط جهاز ➔ وامسح الكود التالي:
            </p>
            
            <div style={{
              padding: "1rem", backgroundColor: "white", borderRadius: "var(--radius-md)",
              border: "2px dashed var(--border)", minHeight: "250px", display: "flex",
