    ...
    <div className={styles.container}>
      ...
      >
          ...
          >
            ...
            >
              ...
              <input
                type="text"
                name="clinic_name"
                defaultValue={settings?.clinic_name || "لومينا ديجيتال"}
                required
                style={{
                  padding: "0.75rem",
            ...
            >
              ...
              <input
                type="text"
                name="phone"
                defaultValue={settings?.phone || "01012345678"}
                style={{
                  padding: "0.75rem",
                  borderRadius: "var(--radius-md)",
                  border: "1px solid var(--border)",
            ...
            >
              ...
              <textarea
                name="address"
                defaultValue={settings?.address || "القاهرة، مدينة نصر"}
                rows={2}
                style={{
                  padding: "0.75rem",
                  borderRadius: "var(--radius-md)",
        ...
        <div className={styles.detailsCard}>
          ...
          >
            هذه المواعيد يستخدمها المساعد الذكي (الشات بوت) لعرض الأوقات المتاحة
            للحجز للمرضى تلقائياً.
          </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  name="end_time"
                  defaultValue={
                    settings?.end_time ? settings.end_time.slice(0, 5) : "22:00"
                  }
                  style={{
                    padding: "0.75rem",
                    borderRadius: "var(--radius-md)",
            ...
            >
              ...
              <input
                type="number"
                name="slot_duration"
                defaultValue={settings?.slot_duration || 30}
                style={{
                  padding: "0.75rem",
                  borderRadius: "var(--radius-md)",
                  border: "1px solid var(--border)",
