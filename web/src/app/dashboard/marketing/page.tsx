...
export default function MarketingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const waUrl =
        process.env.NEXT_PUBLIC_WHATSAPP_SERVICE_URL || "http://localhost:4000";
      ...
      setResult({
        error: "تعذر الاتصال بسيرفر الواتساب. تأكد أن البوت شغال على جهازك.",
      });
    } finally {
      setLoading(false);
    }
    ...
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "var(--text-secondary)", marginTop: "0.5rem" }}>
          أرسل رسائل مجمعة (عروض، تهنئة بالعيد، إشعارات مهمة) لجميع المرضى
          المسجلين لديك بضغطة زر.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              اكتب الرسالة التي تريد إرسالها. يرجى تجنب إرسال رسائل مزعجة (Spam)
              حتى لا يتم حظر الرقم من واتساب.
            </p>
            <textarea
              name="message"
              required
          ...
          >
            {result.success ? (
              <>
                ...
                <div>
                  <h3
                    style={{ margin: "0 0 0.25rem 0", color: "var(--success)" }}
                  >
                    تم الإرسال بنجاح!
                  </h3>
                  <p
                  ...
                  >
                    تم إرسال الرسالة إلى {result.sentCount} مريض (من إجمالي{" "}
                    {result.total} مرضى مسجلين).
                  </p>
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  <h3
                    style={{ margin: "0 0 0.25rem 0", color: "var(--error)" }}
                  >
                    فشل الإرسال
                  </h3>
                  <p
