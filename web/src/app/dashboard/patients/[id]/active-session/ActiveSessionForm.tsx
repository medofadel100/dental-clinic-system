      ...
      >
          ...
          >
            ...
            >
              <label style={{ fontWeight: 600 }}>
                الخدمات المتاحة (اختر لجمع السعر تلقائياً)
              </label>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                {servicesCatalog.length === 0 && (
                  <span style={{ color: "var(--text-secondary)" }}>
                    لم يتم إضافة خدمات في الإعدادات بعد.
                  </span>
                )}
              </div>
            </div>
            ...
            >
              <label style={{ fontWeight: 600 }}>
                العمل الذي تم اليوم (Treatments Done)
              </label>
              <textarea
            ...
            >
              <label style={{ fontWeight: 600 }}>
                خطة الزيارة القادمة (Next Visit Plan)
              </label>
              <textarea
        ...
        >
          ...
          >
            ...
            >
              <label style={{ fontWeight: 600 }}>
                عدد الجلسات لتسديد المبلغ (Sessions/Installments)
              </label>
              <input
                type="number"
                name="total_sessions"
            ...
            >
              ...
              <div>
                ...
                >
                  الاستقبال أكد أن الكشف:{" "}
                  {appt?.checkup_fee_paid ? "مدفوع" : "غير مدفوع"}
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Send size={20} />
                <span>
                  {labLoading ? "جاري الإرسال..." : "إرسال الطلب للمريض واتساب"}
                </span>
              </button>
            </form>
          </div>
