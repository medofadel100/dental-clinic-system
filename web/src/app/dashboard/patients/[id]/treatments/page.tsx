...
export default async function TreatmentsPage({
  ...
  return (
    <div>
      ...
      >
        <strong>💡 ملاحظة هامة:</strong> هذا القسم مخصص{" "}
        <u>للحالات المعقدة فقط</u> مثل (التقويم، زراعة الأسنان، والتركيبات
        الكاملة) التي تتطلب جلسات متعددة وتُدفع على أقساط. <br />
        إذا كان المريض يقوم بإجراء بسيط (مثل خلع أو حشو في جلسة واحدة)، فلا داعي
        لإنشاء خطة علاج هنا، ويمكنك تسجيله مباشرة من تبويب{" "}
        <strong>"الجلسات والفواتير"</strong>.
      </p>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          >
            ...
            >
              <label style={{ fontSize: "0.875rem", fontWeight: 600 }}>
                التكلفة الإجمالية التقديرية (ج.م)
              </label>
              <input
                type="number"
                name="total_cost"
