      ...
      <div className={styles.card} style={{ height: "fit-content" }}>
        ...
        >
          ...
          >
            ...
            >
              تحديد الموعد (اختياري ولكن يُفضل)
            </label>
            <select
              name="appointment_id"
              style={{
            ...
            >
              ...
              {pendingAppointments?.map((appt) => (
                <option key={appt.id} value={appt.id}>
                  موعد:{" "}
                  {new Date(appt.appointment_date).toLocaleString("ar-EG", {
                    weekday: "short",
                    day: "numeric",
                    month: "short",
                    hour: "2-digit",
            ...
            sessions?.map((s) => (
              ...
              >
                ...
                >
                  ...
                  >
                    {s.services_catalog?.name || "خدمة غير مسماة"}
                  </span>
                  <span
                    style={{
                      fontSize: "0.875rem",
                  ...
                  <span style={{ color: "var(--text-secondary)" }}>
                    {s.discount_value > 0 ? (
                      <span style={{ color: "var(--error)" }}>
                        (خصم {s.discount_value}
                        {s.discount_type === "Percentage" ? "%" : " ج.م"})
                      </span>
                    ) : (
                      "بدون خصم"
                    )}
